<?php
  ...
  add_action('init', 'talking_matters_register');

  function talking_matters_register() {

     $labels = array(
  		'name' => _x('Talking Matters', 'post type general name'),
  		'singular_name' => _x('Talking Matters', 'post type singular name'),
      'add_new_item' => __('Add New Briefing'),
  		'edit_item' => __('Edit briefing'),
  		'new_item' => __('New briefing'),
  		'view_item' => __('View briefing'),
  		'search_items' => __('Search Talking Matters'),
    ...
    register_post_type( 'talking-matters' , $args );
  }
