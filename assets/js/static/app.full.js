...
jQuery(window).bind('load', function(){
    ...
    jQuery('.matchHeightSlider').matchHeight();
    jQuery('.matchHeight').matchHeight();
    jQuery('[data-vc-full-width="true"] .feed-match-height').matchHeight();
});
...
jQuery(".disclaimer1 #disclaimerAcceptButton").hide();
	 $('input:radio[name="ban_radio"]').on('change', function() {
		var CT = jQuery(this).attr("value");
		var CTY = jQuery("select#country").val();
		...
		var CT = jQuery('input:radio[name="ban_radio"]').attr("value");
		var CTY = jQuery("select#country").val();
