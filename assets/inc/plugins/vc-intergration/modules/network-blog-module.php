...
$content	= strip_tags(get_post_meta(get_the_ID(), '_Overview', true));
  ...
  $output .= 'Read More <span class="sr-only">about '.get_the_title().'</span></a>';
...
$output .= '</a><span class="views"><em class="icon icon-eye"><span class="sr-only">View</span></em>'.(my_get_post_views()).'</span><span class="comments"><em class="icon icon-comment"><span class="sr-only">Comment</span></em>'.get_comments_number()." Comment<small>(s)</small></span></div>";
}
