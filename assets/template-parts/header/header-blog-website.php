<header id="masthead" class="site-header navbar navbar-fixed-top connect-testing" >
     <div class=" container">
...
wp_nav_menu( $defaults );?>
  ...
  <?php if (!empty(get_option('mainwebsitelink'))) {
 				  echo "<a href='".get_option('mainwebsitelink') ."' class='btn btn-primary navbar-btn' target='_blank'>Main Website</a>";
  } else {
				      global $switched;
					 switch_to_blog(0);
